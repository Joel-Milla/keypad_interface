...
//		*pGPIODOutputDataRegister &= ~(1 << 0);
//
//		// scan de columns
//		// Check C1(PD8) low or high
//		if ( !(*pGPIODInputDataRegister & (1 << 8))) {
//			delay();
//			printf("1\n");
//		}
//		// Check C2(PD9) low or high
//		if ( !(*pGPIODInputDataRegister & (1 << 9))) {
//			delay();
//			printf("2\n");
//		}
//		// Check C3(PD10) low or high
//		if ( !(*pGPIODInputDataRegister & (1 << 10))) {
//			delay();
//			printf("3\n");
//		}
...
//		}
//
//		*pGPIODOutputDataRegister = (uint16_t) 0x0F; // Make all rows high again
//		*pGPIODOutputDataRegister &= ~(1 << 1); // make r2 low (PD1)
//
//		// Check C1(PD8) low or high
//		if ( !(*pGPIODInputDataRegister & (1 << 8))) {
//			delay();
...
//
//		*pGPIODOutputDataRegister = (uint16_t) 0x0F; // Make all rows high again
//		*pGPIODOutputDataRegister &= ~(1 << 2); // make r3 low (PD2)
//
//		// Check C1(PD8) low or high
//		if ( !(*pGPIODInputDataRegister & (1 << 8))) {
//			delay();
...
//
//		*pGPIODOutputDataRegister = (uint16_t) 0x0F; // Make all rows high again
//		*pGPIODOutputDataRegister &= ~(1 << 3); // make r4 low (PD3)
//
//		// Check C1(PD8) low or high
//		if ( !(*pGPIODInputDataRegister & (1 << 8))) {
//			delay();
